...
public enum TransactionMessage {
    ...
    TRANSACTION_MESSAGE_ACCOUNT_DELETE_ERROR_OUT("Account couldn't be deleted - see org.poo.transactions for details"),
    TRANSACTION_MESSAGE_ACCOUNT_DELETE_ERROR("Account couldn't be deleted - there are funds remaining"),
    ...
    TRANSACTION_MESSAGE_REPORT_ACCOUNT_TYPE_ERROR("This kind of report is not supported for a saving account");
